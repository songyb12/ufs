/**
 * Bocchi-master sub-app — fully integrated into UFS Shell.
 *
 * Layout is provided by ShellLayout (Sidebar + Header + Outlet).
 * This component replaces the standalone App.tsx, removing AppShell wrapper.
 */
  ...
  const { fretboardNoteNames, fretboardRootNote, fretboardVoicingPositions } =
    useMemo(() => {
      ...
      if (hasProgression && currentVoicing) {
        return {
          fretboardNoteNames: [] as NoteName[],
