...
export const APP_REGISTRY: AppInfo[] = [
  ...
  },
  {
    id: 'vibe2',
    name: 'VIBE 2.0',
    description: 'SOXL Investment Intelligence Briefing',
    path: '/vibe2',
    icon: 'M2 12l5-5v3h7V7l5 5-5 5v-3H7v3z',
    color: '#06b6d4',
    status: 'active',
    apiBase: '/api/vibe2',
    shortcut: '2',
    port: 8010,
    tags: ['investment', 'SOXL', 'briefing', 'signal', 'leverage', 'macro'],
    features: ['Signal Engine', 'Daily Briefing', 'Signal History', 'Macro Scoring'],
  },
  {
    id: 'eng-ops',
